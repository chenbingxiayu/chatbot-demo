          ...
          return botui.action
            .button({
              ...
              action: [
                ...
                { text: "預約輔導服務", value: 5 },
                { text: "立即與PolyU-Line輔導員聯絡 : (852) 8100 1583", value: 3 },
                { text: "緊急支援", value: 6 },
              ],
            })
            .then(function (res) {
  ...
  function questions_tc() {
    botui.message
      .bot({
        ...
        content:
          "你好﹗" +
          name +"，請回答以下問題，我會總結所得出的答案，提出切合你所需的服務建議。<br/><br/> 以下提問並不能視之為取代專業臨床的心理評估和診斷",
      })
      .then(function () {
        botui.message
          .bot({
                    ...
                    return botui.message
                      ...
                      .then(function () {
                        return botui.message.add({
                          ...
                          photo: polly,
                          content:
                            "請稍等，我正在找輔導員與您聊天。",//? Please wait, I am now finding a counsellor to chat with you.
                        });
                      })
                      .then(function () {
                        return botui.message.add({
      ...
      .bot({
        ...
        if (office_hour == true) {
            ...
            return botui.message.bot({
                ...
                '-香港九龍加士居道30號'+'<br>-Tel: (852)35068888',//? 30 Gascoigne Road, Kowloon, Hong Kong
            }).then(further_help_tc);
        }
      });
  }
